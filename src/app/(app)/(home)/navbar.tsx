  ...
  return (
    <nav className="h-20 flex border-b justify-between bg-white font-medium">
      ...
      <div className="hidden lg:flex">
        ...
        <Button
          asChild
          className="border-l border-t-0 border-b-0 border-r-0 px-12 h-full rounded-none bg-black text-white hover:text-black hover:bg-pink-400 transition-all text-lg"
        >
